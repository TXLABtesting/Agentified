...
const HR_AGENTS = [
  {
    ...
    purpose: "Pick up each new joiner the moment the Talent team hands them over, and run their first days end-to-end — security clearance, first-day documents, ILOE registration and GPSSA pension enrolment — so nothing is missed and the employee starts smoothly.",
    responsibilities: "Recruitment and hiring sit with the Talent team (outside the sector); onboarding begins at the handoff. When the Talent team emails a hired-candidate package, the inbound mail is checked and validated at intake and routed to this agent, which then runs joining from there: raises and tracks the pre-offer security clearance; assembles and validates first-day documents; completes ILOE registration and GPSSA pension enrolment; sets up probation tracking; coordinates HR, IT and Admin so the desk, access and accounts are ready on day one. If the handoff package is incomplete, it asks the Talent team for what's missing before proceeding.",
    process: "HR — Onboarding (Talent-team handoff intake, Security Clearance, First-Day Documents, ILOE, GPSSA), Probation Tracking",
    inputs: ["A hired-candidate handoff (email/package) from the Talent team", "candidate/offer data", "clearance result", "identity & bank documents", "GPSSA/ILOE details"],
    systems: ["Email (Talent handoff)", "Oracle HR", "GovSign", "MOCA Smart", "SharePoint", "GPSSA portal"],
    ...
    status: "Blueprinted", priority: "Strategic", autonomy: "Act-and-notify on handoff intake, document checks, enrolment & coordination; escalate clearance-result decisions and incomplete handoffs",
    humanLoop: "The Talent team owns hiring and the handoff; HR confirms the clearance outcome; Entity Head/Minister approve where required",
    risks: "", nextAction: "",
    talksTo: ["hr-h2", "hr-h3", "hr-h8"],
    subAgents: [{ name: "Recruitment hiring sit Talent team", desc: "Recruitment and hiring sit with the Talent team (outside the sector)", complexity: "Medium", type: "Task", deps: "Email (Talent handoff)", status: "Blueprinted" }, { name: "Onboarding begins handoff. When Talent", desc: "onboarding begins at the handoff. When the Talent team emails a hired-candidate package, the inbound mail is checked and validat", complexity: "Medium", type: "Validation", deps: "Email (Talent handoff)", status: "Blueprinted" }, { name: "Assembles validates first-day documents", desc: "assembles and validates first-day documents", complexity: "Medium", type: "Validation", deps: "Email (Talent handoff)", status: "Blueprinted" }]
  },
  {
...
const IT_AGENTS = [
  {
    ...
    risks: "", nextAction: "",
    talksTo: ["it-i2", "it-i3"],
    subAgents: [{ name: "Creates validates service records", desc: "Creates and validates service records", complexity: "Low", type: "Validation", deps: "MOCA Digital Portal", status: "Blueprinted" }, { name: "Auto-resolves common requests (password", desc: "auto-resolves common requests (password reset, software install, access to standard apps)", complexity: "Low", type: "Task", deps: "MOCA Digital Portal", status: "Blueprinted" }, { name: "Guides user", desc: "guides the user", complexity: "Low", type: "Conversational", deps: "MOCA Digital Portal", status: "Blueprinted" }]
  },
  {
...
const TX_AGENTS = [
  {
    id: "tx-txc1", name: "Zero Bureaucracy Agent", kind: "core", tier: "Core",
    ...
    process: "Zero Government Bureaucracy — step elimination, approval reduction, document removal, requirement simplification, time-to-service (across all departments)",
    inputs: ["Service-journey maps", "approval matrices", "required-document lists", "processing times", "customer feedback"],
    systems: ["MOCA Smart", "Oracle", "SharePoint", "Power BI", "Email"],
    outputs: ["Elimination proposals", "simplified service journeys", "procedures/steps/approvals removed", "time saved", "a live bureaucracy-reduction scorecard"],
    complexity: "High", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on detection, analysis and proposals; every elimination decision stays with the owning department and the committee",
    humanLoop: "Departments and the Zero-Bureaucracy committee approve each removal; nothing is eliminated without sign-off",
    risks: "", nextAction: "",
    talksTo: ["tx-txc2", "tx-txc3"],
    subAgents: [{ name: "Maps every service journey departments", desc: "Maps every service journey across the departments", complexity: "Medium", type: "Task", deps: "MOCA Smart", status: "Blueprinted" }, { name: "Flags duplicate data requests, unnecessary", desc: "flags duplicate data requests, unnecessary approvals, redundant documents and dead waiting time", complexity: "Medium", type: "Task", deps: "MOCA Smart", status: "Blueprinted" }, { name: "Proposes eliminations merges impact", desc: "proposes eliminations and merges with an impact estimate", complexity: "Medium", type: "Task", deps: "MOCA Smart", status: "Blueprinted" }]
  },
  {
    id: "tx-txc2", name: "Digital & App Experience Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Monitors digital journeys across apps and portals; detects friction, broken flows, slow screens and high drop-off steps; runs accessibility checks against the design system; drafts prioritised UX improvement tickets for product and IT; tracks task-success and ease-of-use over time.",
    process: "Digital & app experience — usability, accessibility, journey analytics, design-system compliance",
    inputs: ["App & portal analytics", "user-session data", "accessibility scans", "design-system guidelines", "support tickets"],
    systems: ["MOCA APP", "MOCA Smart", "Power BI", "SharePoint"],
    outputs: ["Prioritised UX fixes", "accessibility findings", "journey-friction reports", "task-success metrics"],
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on detection, analysis and UX tickets; design and release decisions stay with product and IT",
    humanLoop: "Product owners and IT decide what ships; the agent recommends, it does not deploy",
    risks: "", nextAction: "",
    talksTo: ["tx-txc1", "tx-txc3"],
    subAgents: [{ name: "Monitors digital journeys apps portals", desc: "Monitors digital journeys across apps and portals", complexity: "Medium", type: "Monitoring", deps: "MOCA APP", status: "Blueprinted" }, { name: "Detects friction, broken flows, slow", desc: "detects friction, broken flows, slow screens and high drop-off steps", complexity: "Medium", type: "Validation", deps: "MOCA APP", status: "Blueprinted" }, { name: "Runs accessibility checks design system", desc: "runs accessibility checks against the design system", complexity: "Medium", type: "Validation", deps: "MOCA APP", status: "Blueprinted" }]
  },
  {
    id: "tx-txc3", name: "Satisfaction & Continuous-Improvement Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Turns experience findings into owned, dated improvement actions; follows up with departments until each action is closed; measures the before/after satisfaction impact; maintains a live experience-improvement scorecard for leadership; coordinates with the feedback and recipient-experience agents.",
    process: "Continuous improvement — action tracking, department follow-up, satisfaction impact, scorecard",
    inputs: ["Experience findings", "improvement actions", "department owners", "before/after satisfaction data"],
    systems: ["MOCA Smart", "SharePoint", "Power BI", "Email"],
    outputs: ["Tracked improvement actions", "department follow-ups", "satisfaction-impact evidence", "a live experience scorecard"],
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on tracking and follow-up; the improvement itself is delivered by the owning department",
    humanLoop: "Departments deliver the improvement; the agent drives follow-through and measurement",
    risks: "", nextAction: "",
    talksTo: ["tx-txc1", "tx-txc2", "tx-txc6"],
    subAgents: [{ name: "Turns experience findings owned, dated", desc: "Turns experience findings into owned, dated improvement actions", complexity: "Medium", type: "Task", deps: "MOCA Smart", status: "Blueprinted" }, { name: "Follows up departments until each", desc: "follows up with departments until each action is closed", complexity: "Medium", type: "Task", deps: "MOCA Smart", status: "Blueprinted" }, { name: "Measures before/after satisfaction impact", desc: "measures the before/after satisfaction impact", complexity: "Medium", type: "Task", deps: "MOCA Smart", status: "Blueprinted" }]
  },
  {
    id: "tx-txc4", name: "Workload Overload Radar (governed)", kind: "core", tier: "Core",
    purpose: "Detect when someone is genuinely overwhelmed — from work signals, not content — and get them help fast, before overload becomes burnout.",
    responsibilities: "Watches operational signals only (task and queue depth and growth, sustained after-hours work, repeated agent escalations that don't resolve, leave not taken, SLA load) plus what a person volunteers to their assistant; on a sustained overload pattern it helps the person first, auto-rebalances what can safely move, supports the manager with a framed nudge, and triggers a fast human response for severe cases. Never reads message content or metadata.",
    process: "Proactive care (governed) — workload overload detection & supportive response on work signals only",
    inputs: ["Workload & queue signals", "after-hours patterns", "agent-escalation patterns", "leave-not-taken", "volunteered input"],
    systems: ["The agent ecosystem", "Oracle HR (signals)", "MOCA Smart", "Email"],
    outputs: ["Timely supportive intervention", "safe workload rebalancing", "a support-framed manager nudge", "a fast human-response trigger"],
    complexity: "Medium", impact: "High", feasibility: "High",
    status: "Blueprinted", priority: "Quick Win", autonomy: "Act-and-notify on detection, the person-offer and safe rebalancing; manager/support notice is framed as support, never disciplinary",
    humanLoop: "The person chooses what help to accept; managers support, not police; the confidential Wellbeing contact handles sustained cases",
    risks: "", nextAction: "",
    talksTo: ["tx-txc5", "tx-txc6"],
    subAgents: [{ name: "Watches operational signals only (task", desc: "Watches operational signals only (task and queue depth and growth, sustained after-hours work, repeated agent escalations that d", complexity: "Medium", type: "Monitoring", deps: "The agent ecosystem", status: "Blueprinted" }, { name: "Sustained overload pattern helps person", desc: "on a sustained overload pattern it helps the person first, auto-rebalances what can safely move, supports the manager with a fra", complexity: "Medium", type: "Monitoring", deps: "The agent ecosystem", status: "Blueprinted" }]
  },
  {
    id: "tx-txc5", name: "Wellbeing & Work-Environment Insights (governed)", kind: "core", tier: "Core",
    purpose: "Give the wellbeing committee an honest, aggregate picture of the work environment — where pressure, recognition gaps and manager hotspots are building — so they can fix things structurally, before people burn out or leave.",
    responsibilities: "Surfaces team and aggregate climate, drivers and hotspots with recommended structural actions; flight-risk only as team-level themes; never named individual wellbeing or psychological status or scores; aggregate-first with minimum group sizes; access restricted to the named wellbeing committee with every view audited; individual signals route privately to the confidential human support path, never to this dashboard.",
    process: "Proactive care (governed, committee-restricted) — aggregate work-environment insight",
    inputs: ["Team-level engagement & pulse trends", "workload distribution", "leave-not-taken", "recognition gaps", "attrition themes"],
    systems: ["The agent ecosystem", "MOCA Smart", "Power BI (restricted)", "the audit spine"],
    outputs: ["Aggregate work-environment dashboard", "driver analysis", "team hotspots", "recommended structural improvements"],
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on aggregate insight and drafting only; aggregate-first, minimum group sizes, every view audited",
    humanLoop: "The wellbeing committee owns every decision; the agent informs structurally and never profiles an individual",
    risks: "", nextAction: "",
    talksTo: ["tx-txc4", "tx-txc6"],
    subAgents: [{ name: "Surfaces team aggregate climate, drivers", desc: "Surfaces team and aggregate climate, drivers and hotspots with recommended structural actions", complexity: "Medium", type: "Task", deps: "The agent ecosystem", status: "Blueprinted" }, { name: "Flight-risk only team-level themes", desc: "flight-risk only as team-level themes", complexity: "Medium", type: "Task", deps: "The agent ecosystem", status: "Blueprinted" }, { name: "Never named individual wellbeing", desc: "never named individual wellbeing or psychological status or scores", complexity: "Medium", type: "Task", deps: "The agent ecosystem", status: "Blueprinted" }]
  },
  {
    id: "tx-txc6", name: "Proactive Risk & Deadline Sentinel (governed)", kind: "core", tier: "Core",
    purpose: "Make the team look — and be — proactive: surface the stuck request, the slipping deadline or the circular thread so support arrives before it becomes a problem or a complaint.",
    responsibilities: "Watches status and pattern signals (a request open too long, a deadline approaching unmet, a back-and-forth that isn't converging, an agent repeatedly escalating the same case, an SLA about to breach) plus what people share with their assistants; flags the about-to-be-a-problem item to the right owner with a recommended next step and prompts proactive outreach. Never reads message content.",
    process: "Proactive care (governed) — proactive risk & deadline detection on status/pattern signals only",
    inputs: ["Request & case status", "deadline & SLA data", "escalation patterns", "volunteered input"],
    systems: ["The agent ecosystem", "MOCA Smart", "SharePoint", "Email"],
    outputs: ["Early flags on stuck or slipping work", "recommended next steps", "prompts for proactive outreach"],
    complexity: "Medium", impact: "Medium", feasibility: "Medium",
    status: "Blueprinted", priority: "Complex", autonomy: "Act-and-notify on detection and prompting; outreach and decisions stay human",
    humanLoop: "Owners decide and act; the agent surfaces and recommends",
    risks: "", nextAction: "",
    talksTo: ["tx-txc3", "tx-txc4", "tx-txc5"],
    subAgents: [{ name: "Watches status pattern signals (a", desc: "Watches status and pattern signals (a request open too long, a deadline approaching unmet, a back-and-forth that isn't convergin", complexity: "Medium", type: "Monitoring", deps: "The agent ecosystem", status: "Blueprinted" }, { name: "Flags about-to-be-a-problem item right", desc: "flags the about-to-be-a-problem item to the right owner with a recommended next step and prompts proactive outreach. Never reads", complexity: "Medium", type: "Task", deps: "The agent ecosystem", status: "Blueprinted" }]
  }
];

const PM_AGENTS = [
  {
    id: "pm-pm1", name: "Project Planning & Scheduling Agent", kind: "core", tier: "Core",
    ...
    process: "Planning & scheduling — WBS, milestones, dependencies, critical path, baselining",
    ...
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on drafting, scheduling and alerts; scope and date commitments stay with the PM",
    humanLoop: "The project manager owns the plan and commitments; the agent drafts and maintains it",
    risks: "", nextAction: "",
    talksTo: ["pm-pm2", "pm-pm3", "pm-pm5"],
    subAgents: [{ name: "Drafts plans, WBS, schedules milestones", desc: "Drafts plans, WBS, schedules and milestones", complexity: "Medium", type: "Drafting", deps: "MS Project", status: "Blueprinted" }, { name: "Maps dependencies critical path", desc: "maps dependencies and the critical path", complexity: "Medium", type: "Task", deps: "MS Project", status: "Blueprinted" }, { name: "Detects slippage re-baselines", desc: "detects slippage and re-baselines", complexity: "Medium", type: "Task", deps: "MS Project", status: "Blueprinted" }]
  },
  {
    id: "pm-pm2", name: "Portfolio & Prioritisation Agent", kind: "core", tier: "Core",
    ...
    process: "Portfolio & prioritisation — scoring, ranking, pipeline balance, portfolio reviews",
    ...
    complexity: "High", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on scoring and analysis; funding and prioritisation decisions stay with leadership",
    humanLoop: "Leadership decides what to fund; the agent scores and recommends",
    risks: "", nextAction: "",
    talksTo: ["pm-pm1", "pm-pm3", "pm-pm7", "pm-pm8"],
    subAgents: [{ name: "Maintains portfolio", desc: "Maintains the portfolio", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Scores ranks value, risk, effort", desc: "scores and ranks by value, risk, effort and strategic fit", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Balances pipeline", desc: "balances the pipeline", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }]
  },
  {
    id: "pm-pm3", name: "Risk & Issue Management Agent", kind: "core", tier: "Core",
    ...
    process: "Risk & issue management — register, assessment, mitigation tracking, escalation",
    ...
    complexity: "Medium", impact: "High", feasibility: "High",
    status: "Blueprinted", priority: "Complex", autonomy: "Act-and-notify on tracking, chasing and escalation; risk-acceptance decisions stay with the board",
    humanLoop: "The project board accepts or mitigates risk; the agent tracks and escalates",
    risks: "", nextAction: "",
    talksTo: ["pm-pm1", "pm-pm2", "pm-pm4"],
    subAgents: [{ name: "Maintains register per project", desc: "Maintains the register per project", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }, { name: "Assesses likelihood impact", desc: "assesses likelihood and impact", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }, { name: "Tracks mitigations owners", desc: "tracks mitigations and owners", complexity: "Medium", type: "Monitoring", deps: "SharePoint", status: "Blueprinted" }]
  },
  {
    id: "pm-pm4", name: "Status Reporting & Insights Agent", kind: "core", tier: "Core",
    ...
    process: "Status reporting — RAG roll-up, dashboards, executive highlights, distribution",
    ...
    complexity: "Medium", impact: "High", feasibility: "High",
    status: "Blueprinted", priority: "Complex", autonomy: "Act-and-notify on report assembly and distribution; the PM owns the narrative",
    humanLoop: "The PM validates the status; the agent assembles it",
    risks: "", nextAction: "",
    talksTo: ["pm-pm3", "pm-pm6"],
    subAgents: [{ name: "Auto-generates status reports dashboards", desc: "Auto-generates status reports and dashboards", complexity: "Medium", type: "Drafting", deps: "Power BI", status: "Blueprinted" }, { name: "Rolls up RAG status, progress", desc: "rolls up RAG status, progress, milestones, risks and spend", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Writes executive highlight", desc: "writes the executive highlight", complexity: "Medium", type: "Drafting", deps: "Power BI", status: "Blueprinted" }]
  },
  {
    id: "pm-pm5", name: "Resource & Capacity Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Tracks allocation and utilisation across projects; forecasts capacity crunches; flags over- and under-allocation; supports resource levelling; coordinates with departments on assignments. Draws on HR workforce data (H5) rather than duplicating it.",
    process: "Resource & capacity — allocation, utilisation, capacity forecast, levelling",
    ...
    complexity: "Medium", impact: "Medium", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on analysis and options; assignment decisions stay with managers",
    humanLoop: "Managers assign people; the agent forecasts and recommends",
    risks: "", nextAction: "",
    talksTo: ["pm-pm1"],
    subAgents: [{ name: "Tracks allocation utilisation projects", desc: "Tracks allocation and utilisation across projects", complexity: "Medium", type: "Monitoring", deps: "MS Project", status: "Blueprinted" }, { name: "Forecasts capacity crunches", desc: "forecasts capacity crunches", complexity: "Medium", type: "Reporting", deps: "MS Project", status: "Blueprinted" }, { name: "Flags over- under-allocation", desc: "flags over- and under-allocation", complexity: "Medium", type: "Task", deps: "MS Project", status: "Blueprinted" }]
  },
  {
    id: "pm-pm6", name: "Stakeholder & Governance Agent", kind: "core", tier: "Core",
    ...
    process: "Stakeholder & governance — steering packs, gate reviews, approvals, decisions & actions",
    ...
    complexity: "Medium", impact: "Medium", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on preparation, scheduling and tracking; gate and approval decisions stay with the board",
    humanLoop: "The project board decides at each gate; the agent prepares and tracks",
    risks: "", nextAction: "",
    talksTo: ["pm-pm4", "pm-pm8"],
    subAgents: [{ name: "Maps stakeholders interests", desc: "Maps stakeholders and their interests", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }, { name: "Drafts steering packs minutes", desc: "drafts steering packs and minutes", complexity: "Medium", type: "Drafting", deps: "SharePoint", status: "Blueprinted" }, { name: "Manages gate reviews approvals", desc: "manages gate reviews and approvals", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }]
  },
  {
    id: "pm-pm7", name: "Budget & Benefits Realisation Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Tracks budgets, commitments and actual spend; forecasts cost at completion; flags overruns early; defines and monitors benefit measures; confirms benefits are realised after go-live; coordinates with Finance (F5/F6) rather than duplicating the ledger.",
    process: "Budget & benefits — budget vs spend, estimate-at-completion, benefit definition & realisation",
    ...
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on tracking, forecasting and alerts; budget decisions stay with Finance and the board",
    humanLoop: "Finance and the board own the budget; the agent tracks and forecasts",
    risks: "", nextAction: "",
    talksTo: ["pm-pm2", "pm-pm8"],
    subAgents: [{ name: "Tracks budgets, commitments actual spend", desc: "Tracks budgets, commitments and actual spend", complexity: "Medium", type: "Monitoring", deps: "Oracle", status: "Blueprinted" }, { name: "Forecasts cost completion", desc: "forecasts cost at completion", complexity: "Medium", type: "Reporting", deps: "Oracle", status: "Blueprinted" }, { name: "Flags overruns early", desc: "flags overruns early", complexity: "Medium", type: "Task", deps: "Oracle", status: "Blueprinted" }]
  },
  {
    id: "pm-pm8", name: "Project Overlap & Synergy Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Reads every new project request and SOW; compares objectives, deliverables, systems, vendors and beneficiaries against the live portfolio; scores similarity and overlap; flags duplicate or near-duplicate efforts; recommends consolidation, shared delivery or reuse and names the teams that should collaborate; estimates the avoided spend; surfaces a decision-ready package to leadership.",
    process: "Overlap & duplication detection — scope comparison, similarity scoring, consolidation & reuse recommendations, avoided-spend estimate",
    ...
    complexity: "High", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on scanning, matching and recommendations; the merge/stop/fund decision stays with leadership and the PMO",
    ...
    risks: "", nextAction: "",
    talksTo: ["pm-pm2", "pm-pm6", "pm-pm7"],
    subAgents: [{ name: "Reads every new project request", desc: "Reads every new project request and SOW", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Compares objectives, deliverables,", desc: "compares objectives, deliverables, systems, vendors and beneficiaries against the live portfolio", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Scores similarity overlap", desc: "scores similarity and overlap", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }]
  }
];

const SH_AGENTS = [
  {
    id: "sh-sh1", name: "Sector Meetings & Agenda Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Schedules the recurring and ad-hoc sector leadership meetings; assembles the agenda from open actions, department inputs and items needing a decision; collects and packages pre-reads from each department; captures minutes, decisions and owners live; converts every action into a tracked item with an owner and due date; circulates outcomes.",
    process: "Leadership meeting cycle — scheduling, agenda build, pre-read assembly, minutes & decisions, action capture & circulation",
    ...
    outputs: ["Confirmed meetings", "agendas", "pre-read packs", "minutes", "a live decisions-&-actions log"],
    complexity: "Medium", impact: "High", feasibility: "High",
    status: "Blueprinted", priority: "Complex", autonomy: "Act-and-notify on scheduling, agenda drafting, pack assembly and minute capture; agenda priorities and decisions stay with the head",
    humanLoop: "The sector head sets the agenda priorities and chairs; decisions and their wording are the head's; the office prepares and records",
    risks: "", nextAction: "",
    talksTo: ["sh-sh2", "sh-sh3", "sh-sh5"],
    subAgents: [{ name: "Schedules recurring ad-hoc sector", desc: "Schedules the recurring and ad-hoc sector leadership meetings", complexity: "Medium", type: "Task", deps: "Outlook/Calendar", status: "Blueprinted" }, { name: "Assembles agenda open actions, department", desc: "assembles the agenda from open actions, department inputs and items needing a decision", complexity: "Medium", type: "Orchestration", deps: "Outlook/Calendar", status: "Blueprinted" }, { name: "Collects packages pre-reads each", desc: "collects and packages pre-reads from each department", complexity: "Medium", type: "Task", deps: "Outlook/Calendar", status: "Blueprinted" }]
  },
  {
    id: "sh-sh2", name: "Cross-Department Milestone & Follow-up Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Maintains the master milestone & commitment register across all departments; pulls status from each department and the PMO; compares actual vs committed dates; chases owners for updates; flags slippage and dependency risks; prepares a decision-ready escalation when a milestone is at risk; keeps the head's on-track / slipping view current. Draws on the PMO and V13 rather than duplicating project plans.",
    process: "Cross-department milestone tracking — register, status pull, slippage detection, owner follow-up, escalation",
    ...
    outputs: ["Master milestone register", "on-track/slipping view", "slippage & dependency alerts", "escalation packages"],
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on tracking, chasing and flagging; recovery and escalation decisions stay with department heads and the sector head",
    humanLoop: "Department heads own their milestones and the recovery plan; the sector head decides on escalations; the agent tracks, chases and surfaces",
    risks: "", nextAction: "",
    talksTo: ["sh-sh1", "sh-sh3"],
    subAgents: [{ name: "Maintains master milestone & commitment", desc: "Maintains the master milestone & commitment register across all departments", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Pulls status each department PMO", desc: "pulls status from each department and the PMO", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }, { name: "Compares actual vs committed dates", desc: "compares actual vs committed dates", complexity: "Medium", type: "Task", deps: "Power BI", status: "Blueprinted" }]
  },
  {
    id: "sh-sh3", name: "Decisions & Directives Tracker", kind: "core", tier: "Core",
    ...
    responsibilities: "Captures every decision and directive from meetings, correspondence and ad-hoc instructions; assigns each to an owning department with a clear ask and due date; tracks progress; chases overdue items; reports closure (or the reason it stalled) back to the head; keeps an auditable record of what was asked and what happened. Where a directive needs a formal approval, it hands that to the Approval Concierge (G1).",
    process: "Decision & directive lifecycle — capture, assignment, tracking, chasing, closure, audit trail",
    ...
    outputs: ["Live decisions-&-directives register", "owner/due-date assignment", "overdue chasing", "closure reports", "audit trail"],
    complexity: "Medium", impact: "High", feasibility: "High",
    status: "Blueprinted", priority: "Complex", autonomy: "Act-and-notify on logging, routing and chasing; the decision itself and sign-off on closure stay with the head and owners",
    humanLoop: "The sector head issues the decision/directive and accepts closure; owners deliver; the agent records, routes and follows up",
    risks: "", nextAction: "",
    talksTo: ["sh-sh1", "sh-sh2", "sh-sh4"],
    subAgents: [{ name: "Captures every decision directive meetings", desc: "Captures every decision and directive from meetings, correspondence and ad-hoc instructions", complexity: "Medium", type: "Conversational", deps: "SharePoint", status: "Blueprinted" }, { name: "Assigns each owning department clear", desc: "assigns each to an owning department with a clear ask and due date", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }, { name: "Tracks progress", desc: "tracks progress", complexity: "Medium", type: "Monitoring", deps: "SharePoint", status: "Blueprinted" }]
  },
  {
    id: "sh-sh4", name: "Executive Correspondence & Briefing Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Drafts the head's letters, decision memos, talking points and meeting/engagement briefings; pulls the relevant facts, history and positions from departments and records; tailors tone for the audience; routes for review and e-signature; keeps a clean, searchable record. Uses the Policy/Memo Author (V7) for formal instruments rather than duplicating it.",
    process: "Executive correspondence & briefing — drafting, fact assembly, review routing, signature, record-keeping",
    ...
    outputs: ["Drafted correspondence & memos", "talking points", "engagement briefing packs", "signed-and-archived records"],
    complexity: "Medium", impact: "High", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on drafting, fact assembly and routing; wording, approval and signature stay with the head",
    humanLoop: "The sector head approves and signs every outbound communication and the briefing line; the agent drafts and assembles",
    risks: "", nextAction: "",
    talksTo: ["sh-sh3", "sh-sh5"],
    subAgents: [{ name: "Drafts head's letters, decision memos", desc: "Drafts the head's letters, decision memos, talking points and meeting/engagement briefings", complexity: "Medium", type: "Drafting", deps: "SharePoint", status: "Blueprinted" }, { name: "Pulls relevant facts, history positions", desc: "pulls the relevant facts, history and positions from departments and records", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }, { name: "Tailors tone audience", desc: "tailors tone for the audience", complexity: "Medium", type: "Task", deps: "SharePoint", status: "Blueprinted" }]
  },
  {
    id: "sh-sh5", name: "Stakeholder & Engagement Coordination Agent", kind: "core", tier: "Core",
    ...
    responsibilities: "Maps the head's key stakeholders and engagement cadence; schedules and sequences engagements; ensures each has a briefing pack (from SH4) and a clear objective; captures commitments made and routes them as tracked actions (to SH3); follows up on what others committed; keeps the relationship history.",
    process: "Stakeholder & engagement coordination — stakeholder map, scheduling, objective-setting, commitment capture, follow-up",
    ...
    outputs: ["Engagement schedule with objectives", "prepared engagements", "captured commitments (in & out)", "follow-up tracking", "relationship history"],
    complexity: "Medium", impact: "Medium", feasibility: "Medium",
    status: "Blueprinted", priority: "Future Phase", autonomy: "Act-and-notify on scheduling, preparation and follow-up; relationship and commitment decisions stay with the head",
    humanLoop: "The sector head sets the relationships and objectives and makes the commitments; the agent prepares, captures and follows up",
    risks: "", nextAction: "",
    talksTo: ["sh-sh1", "sh-sh4"],
    subAgents: [{ name: "Maps head's key stakeholders engagement", desc: "Maps the head's key stakeholders and engagement cadence", complexity: "Medium", type: "Task", deps: "Outlook/Calendar", status: "Blueprinted" }, { name: "Schedules sequences engagements", desc: "schedules and sequences engagements", complexity: "Medium", type: "Orchestration", deps: "Outlook/Calendar", status: "Blueprinted" }, { name: "Ensures each has briefing pack", desc: "ensures each has a briefing pack (from SH4) and a clear objective", complexity: "Medium", type: "Reporting", deps: "Outlook/Calendar", status: "Blueprinted" }]
  }
];
...
const SHARED_AGENTS = [
  ...
  {
    id: "sh-v1", name: "Employee Companion (sector-wide)", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v2", name: "Manager & Requester Companion", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v3", name: "Leadership Briefing & Decision-Support Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v4", name: "Knowledge-Capture & Policy-Simplifier", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v5", name: "Proactive Nudge & Deadline Radar", kind: "value-add", tier: "Value-add",
    ...
    risks: "", nextAction: "",
    talksTo: ["sh-v10", "sh-v3", "sh-v8", "sh-v9"],
  ...
  {
    id: "sh-v6", name: "Audit-Readiness & Remediation Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v7", name: "Policy, Decree & Memo Author", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v8", name: "Bilingual Call-Centre Voice Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v9", name: "Continuous Risk & Quality Assurance", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v10", name: "Feedback & Sentiment Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v11", name: "Wellbeing & Workload-Balance Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v12", name: "Service-Recipient Experience Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v13", name: "PMO & Outcomes Agent", kind: "value-add", tier: "Value-add",
  ...
  {
    id: "sh-v14", name: "Delegation-of-Authority & Approvals Governance Agent", kind: "value-add", tier: "Value-add",
...
const DEPARTMENTS = [
  ...
  },
  {
    ...
    description: "The experience engine — digital & app experience, service & process experience, satisfaction follow-up, and the three governed proactive-care agents (workload, wellbeing and risk), with every individual concern routed to a human.",
    owner: "Total Experience Team", focal: "Hessa Al Falasi · Head of Total Experience", lastUpdated: "2026-06-26", agents: TX_AGENTS
  },
  {
    id: "pm", name: "Project Management Office", short: "PMO",
    description: "The delivery backbone — planning, portfolio, risk, status, resourcing, governance, budget/benefits and project-overlap detection, so initiatives land on time, on value and on budget.",
    owner: "Project Management Office", focal: "Sultan Al Romaithi · Head of PMO", lastUpdated: "2026-06-26", agents: PM_AGENTS
  },
  {
    id: "sh", name: "Sector Head Office", short: "Sector Head",
    description: "The coordination layer above the departments — convening sector leadership meetings, tracking the milestones of every department and the decisions and directives of the sector head to closure, with judgement and accountability kept with the head.",
